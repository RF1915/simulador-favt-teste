...
def calc_favt(payload: Dict[str, Any], tables: Dict[str, pd.DataFrame], ref: Dict[str, Any], mode: str):
    ...
    return {
        ...
        "inputs_norm": {
            "bairro": bairro, "zona": zona, "area_total": area_total, "area_coberta": area_coberta,
            "n_vistas": n_vistas, "n_pisos": n_pisos, "largura_infra": largura_infra,
            "largura_fachada": largura_fachada, "uso": uso, "zona_historica": zona_historica
        }
    }
...
with col2:
    ...
    bairro2 = st.selectbox("Bairro/Localidade (FAVT2)", bairros, key="b2", index=bairros.index(bairro1) if bairro1 in bairros else 0)
...
if run:
    try:
        res1 = calc_favt({
            "bairro": bairro1, "zona": zona1, "area_total": area_total1, "area_coberta": area_coberta1,
        ...
        res2 = calc_favt({
            ...
            "uso": uso2, "zona_historica": zona_hist2_val,
